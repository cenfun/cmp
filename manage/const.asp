...
<div id="menu">
  ...
  <a href="system.asp?action=config">系统管理</a> | <a href="system.asp?action=user">用户管理</a> | <a href="system.asp?action=skins">皮肤管理</a> | <a href="system.asp?action=plugins">插件管理</a> | 
  <%end if%>
  ...
  <%else%>
  <span><%=site_name%></span><a href="index.asp">首页</a> | <a href="index.asp?action=reg">免费注册</a> | <a href="index.asp">登录</a> | <a href="userlist.asp">用户列表</a>
  <%end if%>
</div>
<%
end sub
